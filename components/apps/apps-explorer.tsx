...
export function AppsExplorer({ apps, categories }: AppsExplorerProps) {
  ...
  return (
    <DebugBorder enabled={debugEnabled} componentName="AppsExplorer" filePath="components/apps/apps-explorer.tsx">
      <section className="space-y-6">
        <DebugBorder
          enabled={debugEnabled}
          componentName="AppsExplorer.Controls"
          filePath="components/apps/apps-explorer.tsx"
        >
        ...
        <DebugBorder enabled={debugEnabled} componentName="AppsExplorer.Grid" filePath="components/apps/apps-explorer.tsx">
